// Pregunta al usuario los valores (Ancho, Alto, Color)
...
// Selecciona la caja (el div)
const caja = document.querySelector('div');

// Rellena cada atributo 'data-*' con su valor 
caja.dataset.width = widthC;
caja.dataset.heigth = heightC; 
caja.dataset.bordercolor = colorC; 

// Recoge los valores de los atributos data y aplica los estilos 
