...
<body>
    ...
    <tr><form action="gestuser.php" method="post">
        ...
        <td><label>Rol:</label></td><td><input type="text" name="rol"></td>
    </tr>
    <tr>
        <td colspan="6">
    ...
    <br><br>
    <a href="index.php"><button>Volver a index1</button></a>
    <a href="index2.php"><button>Volver a index2</button></a>
